...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    // Mock login - in production this would trigger Google OAuth
      ...
      <Card className="w-full max-w-md border-brand-neutral-100 shadow-lg">
        ...
        <CardContent className="space-y-4">
          <Button
            ...
            className="w-full gap-3 h-12 bg-brand-navy-800 text-white hover:bg-brand-navy-900 border-none"
          >
          ...
          <div className="relative">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full border-t border-brand-neutral-100" />
            </div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-brand-navy-300">
                Demo Mode
              </span>
            </div>
          </div>

          <p className="text-center text-sm text-brand-navy-600">
            Click the button above to enter the demo. No real authentication required.
          </p>
        </CardContent>
      </Card>
    </div>
